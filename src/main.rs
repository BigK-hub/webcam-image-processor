...
const MODE_NAMES: [&str; 14] = ["Normal", "Sobel", "SobelColour", "Threshold", "ThresholdColour", "Dithering","GaussianBlur", "Emboss","Outline","BoxBlur","GreyScale", "Sharpen", "SharpenColour", "CrossBlur"];
